...
export default function DemoC5Screen() {
  ...
  return (
    <View style={styles.wrap}>
      ...
      >
        <Reveal delay={120}>
          <Text style={styles.eyebrow}>✨ L&apos;écriture de Mémé déchiffrée</Text>
        </Reveal>
        <Reveal delay={240}>
        ...
        <Reveal delay={360}>
          <Text style={styles.sub}>Carnet familial · 6 secondes</Text>
        </Reveal>

        <Reveal delay={520} style={styles.cardWrap}>
          <RecipeCardWow recipe={demoRecipes.blanquette} />
        </Reveal>
      </ScrollView>

      <OnboardingFooter label="Terminer la démo ✨" onPress={onContinue} />
    </View>
  );
}
