...
export default function DemoB1Screen() {
  ...
  return (
    <View style={styles.wrap}>
      ...
      <View style={styles.center}>
        <Reveal delay={60}>
          <Text style={styles.eyebrow}>Encore mieux 🌐</Text>
        </Reveal>
        <Reveal delay={180}>
          <Text style={styles.title}>
            Importe depuis{" "}
            <Text style={styles.titleAccent}>les sites web</Text>
          </Text>
        </Reveal>
        <Reveal delay={300}>
          <Text style={styles.body}>
            On traduit, on convertit, on garde la photo.
          </Text>
        </Reveal>
      ...
      <OnboardingFooter
        ...
        onPress={() => router.push("/onboarding/demo-b2")}
      />
    </View>
  );
}
