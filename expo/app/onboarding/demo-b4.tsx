...
const SHARE_IMG = require("@/assets/demo/B4-share-safari.png");

export default function DemoB4Screen() {
  ...
  return (
    <View style={styles.wrap}>
      <View style={[styles.header, { paddingTop: insets.top + 60 }]}>
        ...
        <Reveal delay={140}>
          <Text style={styles.title}>
            Tape sur <Text style={styles.titleAccent}>RecetteBox</Text> pour
            importer
          </Text>
        </Reveal>
      </View>
      ...
      <View style={styles.mockupArea}>
        ...
        <HaloPulse size={80} position={{ top: "56%", left: "25%" }} />
        <TapPill text="Tape 👇" position={{ top: "47%", left: "22%" }} />
      </View>
